...
void ErrorsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData ErrorsView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ErrorsView::staticMetaObject = {
    { &QListView::staticMetaObject, qt_meta_stringdata_ErrorsView,
      qt_meta_data_ErrorsView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ErrorsView::getStaticMetaObject() { return staticMetaObject; }
