...
const QMetaObjectExtraData PhraseModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PhraseModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_PhraseModel,
      qt_meta_data_PhraseModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PhraseModel::getStaticMetaObject() { return staticMetaObject; }
