...
void PhraseBook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        PhraseBook *_t = static_cast<PhraseBook *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData PhraseBook::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PhraseBook::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PhraseBook,
      qt_meta_data_PhraseBook, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PhraseBook::getStaticMetaObject() { return staticMetaObject; }
