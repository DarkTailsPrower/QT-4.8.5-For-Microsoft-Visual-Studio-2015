...
const QMetaObjectExtraData qdesigner_internal::BuddyEditorTool::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::BuddyEditorTool::staticMetaObject = {
    { &QDesignerFormWindowToolInterface::staticMetaObject, qt_meta_stringdata_qdesigner_internal__BuddyEditorTool,
      qt_meta_data_qdesigner_internal__BuddyEditorTool, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::BuddyEditorTool::getStaticMetaObject() { return staticMetaObject; }
