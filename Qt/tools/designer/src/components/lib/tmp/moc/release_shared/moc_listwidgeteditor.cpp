...
void qdesigner_internal::ListWidgetEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::ListWidgetEditor::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::ListWidgetEditor::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_qdesigner_internal__ListWidgetEditor,
      qt_meta_data_qdesigner_internal__ListWidgetEditor, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::ListWidgetEditor::getStaticMetaObject() { return staticMetaObject; }
