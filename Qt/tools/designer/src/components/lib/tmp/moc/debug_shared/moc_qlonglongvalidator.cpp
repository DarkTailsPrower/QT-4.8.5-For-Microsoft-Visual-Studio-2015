...
void qdesigner_internal::QLongLongValidator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::QLongLongValidator::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::QLongLongValidator::staticMetaObject = {
    { &QValidator::staticMetaObject, qt_meta_stringdata_qdesigner_internal__QLongLongValidator,
      qt_meta_data_qdesigner_internal__QLongLongValidator, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::QLongLongValidator::getStaticMetaObject() { return staticMetaObject; }
...
void qdesigner_internal::QULongLongValidator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::QULongLongValidator::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};
...
const QMetaObject qdesigner_internal::QULongLongValidator::staticMetaObject = {
    { &QValidator::staticMetaObject, qt_meta_stringdata_qdesigner_internal__QULongLongValidator,
      qt_meta_data_qdesigner_internal__QULongLongValidator, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::QULongLongValidator::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
