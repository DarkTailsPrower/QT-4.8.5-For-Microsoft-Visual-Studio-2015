...
void qdesigner_internal::SignalSlotEditorTool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::SignalSlotEditorTool::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::SignalSlotEditorTool::staticMetaObject = {
    { &QDesignerFormWindowToolInterface::staticMetaObject, qt_meta_stringdata_qdesigner_internal__SignalSlotEditorTool,
      qt_meta_data_qdesigner_internal__SignalSlotEditorTool, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::SignalSlotEditorTool::getStaticMetaObject() { return staticMetaObject; }
