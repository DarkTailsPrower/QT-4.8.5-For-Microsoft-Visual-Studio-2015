...
void qdesigner_internal::WidgetEditorTool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::WidgetEditorTool::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::WidgetEditorTool::staticMetaObject = {
    { &QDesignerFormWindowToolInterface::staticMetaObject, qt_meta_stringdata_qdesigner_internal__WidgetEditorTool,
      qt_meta_data_qdesigner_internal__WidgetEditorTool, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::WidgetEditorTool::getStaticMetaObject() { return staticMetaObject; }
