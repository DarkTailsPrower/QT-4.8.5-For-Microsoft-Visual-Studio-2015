...
void qdesigner_internal::WidgetBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        WidgetBox *_t = static_cast<WidgetBox *>(_o);
        switch (_id) {
        case 0: _t->handleMousePress((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< const QPoint(*)>(_a[3]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData qdesigner_internal::WidgetBox::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::WidgetBox::staticMetaObject = {
    { &QDesignerWidgetBox::staticMetaObject, qt_meta_stringdata_qdesigner_internal__WidgetBox,
      qt_meta_data_qdesigner_internal__WidgetBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::WidgetBox::getStaticMetaObject() { return staticMetaObject; }
