...
const QMetaObjectExtraData qdesigner_internal::InPlaceWidgetHelper::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::InPlaceWidgetHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qdesigner_internal__InPlaceWidgetHelper,
      qt_meta_data_qdesigner_internal__InPlaceWidgetHelper, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::InPlaceWidgetHelper::getStaticMetaObject() { return staticMetaObject; }
