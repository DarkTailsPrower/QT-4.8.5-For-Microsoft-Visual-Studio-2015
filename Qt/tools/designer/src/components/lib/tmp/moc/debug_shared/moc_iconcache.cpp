...
void qdesigner_internal::IconCache::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::IconCache::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::IconCache::staticMetaObject = {
    { &QDesignerIconCacheInterface::staticMetaObject, qt_meta_stringdata_qdesigner_internal__IconCache,
      qt_meta_data_qdesigner_internal__IconCache, &staticMetaObjectExtraData }
};
