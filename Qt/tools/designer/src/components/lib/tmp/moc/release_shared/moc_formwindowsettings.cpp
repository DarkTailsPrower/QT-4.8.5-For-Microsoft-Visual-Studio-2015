...
void qdesigner_internal::FormWindowSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::FormWindowSettings::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::FormWindowSettings::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_qdesigner_internal__FormWindowSettings,
      qt_meta_data_qdesigner_internal__FormWindowSettings, &staticMetaObjectExtraData }
};
