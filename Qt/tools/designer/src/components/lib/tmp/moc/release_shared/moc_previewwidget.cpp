...
void qdesigner_internal::PreviewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::PreviewWidget::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::PreviewWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_qdesigner_internal__PreviewWidget,
      qt_meta_data_qdesigner_internal__PreviewWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::PreviewWidget::getStaticMetaObject() { return staticMetaObject; }
