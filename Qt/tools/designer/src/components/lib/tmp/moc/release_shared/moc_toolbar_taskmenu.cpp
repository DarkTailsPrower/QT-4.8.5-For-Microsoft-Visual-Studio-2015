...
void qdesigner_internal::ToolBarTaskMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::ToolBarTaskMenu::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::ToolBarTaskMenu::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qdesigner_internal__ToolBarTaskMenu,
      qt_meta_data_qdesigner_internal__ToolBarTaskMenu, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::ToolBarTaskMenu::getStaticMetaObject() { return staticMetaObject; }
...
void qdesigner_internal::StatusBarTaskMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        StatusBarTaskMenu *_t = static_cast<StatusBarTaskMenu *>(_o);
        switch (_id) {
        case 0: _t->removeStatusBar(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData qdesigner_internal::StatusBarTaskMenu::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};
...
const QMetaObject qdesigner_internal::StatusBarTaskMenu::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qdesigner_internal__StatusBarTaskMenu,
      qt_meta_data_qdesigner_internal__StatusBarTaskMenu, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::StatusBarTaskMenu::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
