...
void qdesigner_internal::LineEditTaskMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::LineEditTaskMenu::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::LineEditTaskMenu::staticMetaObject = {
    { &QDesignerTaskMenu::staticMetaObject, qt_meta_stringdata_qdesigner_internal__LineEditTaskMenu,
      qt_meta_data_qdesigner_internal__LineEditTaskMenu, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::LineEditTaskMenu::getStaticMetaObject() { return staticMetaObject; }
