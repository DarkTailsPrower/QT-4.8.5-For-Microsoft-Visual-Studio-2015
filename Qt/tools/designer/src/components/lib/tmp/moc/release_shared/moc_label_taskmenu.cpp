...
const QMetaObjectExtraData qdesigner_internal::LabelTaskMenu::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::LabelTaskMenu::staticMetaObject = {
    { &QDesignerTaskMenu::staticMetaObject, qt_meta_stringdata_qdesigner_internal__LabelTaskMenu,
      qt_meta_data_qdesigner_internal__LabelTaskMenu, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::LabelTaskMenu::getStaticMetaObject() { return staticMetaObject; }
