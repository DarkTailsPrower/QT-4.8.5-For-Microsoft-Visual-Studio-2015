...
const QMetaObjectExtraData qdesigner_internal::StringListEditorButton::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::StringListEditorButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_qdesigner_internal__StringListEditorButton,
      qt_meta_data_qdesigner_internal__StringListEditorButton, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::StringListEditorButton::getStaticMetaObject() { return staticMetaObject; }
