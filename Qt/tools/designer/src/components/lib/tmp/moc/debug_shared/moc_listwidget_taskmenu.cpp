...
void qdesigner_internal::ListWidgetTaskMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        ListWidgetTaskMenu *_t = static_cast<ListWidgetTaskMenu *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData qdesigner_internal::ListWidgetTaskMenu::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::ListWidgetTaskMenu::staticMetaObject = {
    { &QDesignerTaskMenu::staticMetaObject, qt_meta_stringdata_qdesigner_internal__ListWidgetTaskMenu,
      qt_meta_data_qdesigner_internal__ListWidgetTaskMenu, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::ListWidgetTaskMenu::getStaticMetaObject() { return staticMetaObject; }
