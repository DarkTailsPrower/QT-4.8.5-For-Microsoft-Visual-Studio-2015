...
void qdesigner_internal::LinePropertySheet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::LinePropertySheet::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::LinePropertySheet::staticMetaObject = {
    { &QDesignerPropertySheet::staticMetaObject, qt_meta_stringdata_qdesigner_internal__LinePropertySheet,
      qt_meta_data_qdesigner_internal__LinePropertySheet, &staticMetaObjectExtraData }
};
