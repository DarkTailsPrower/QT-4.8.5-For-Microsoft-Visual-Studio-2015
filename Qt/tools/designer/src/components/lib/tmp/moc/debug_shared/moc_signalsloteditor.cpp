...
const QMetaObjectExtraData qdesigner_internal::SignalSlotEditor::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::SignalSlotEditor::staticMetaObject = {
    { &ConnectionEdit::staticMetaObject, qt_meta_stringdata_qdesigner_internal__SignalSlotEditor,
      qt_meta_data_qdesigner_internal__SignalSlotEditor, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::SignalSlotEditor::getStaticMetaObject() { return staticMetaObject; }
