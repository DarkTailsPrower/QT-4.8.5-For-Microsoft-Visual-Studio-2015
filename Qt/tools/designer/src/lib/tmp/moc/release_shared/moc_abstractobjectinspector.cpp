...
void QDesignerObjectInspectorInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QDesignerObjectInspectorInterface *_t = static_cast<QDesignerObjectInspectorInterface *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QDesignerObjectInspectorInterface::staticMetaObjectExtraData = {
...
const QMetaObject QDesignerObjectInspectorInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QDesignerObjectInspectorInterface,
      qt_meta_data_QDesignerObjectInspectorInterface, &staticMetaObjectExtraData }
};
