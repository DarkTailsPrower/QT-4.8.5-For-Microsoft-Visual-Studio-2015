...
void QDesignerMetaDataBaseInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QDesignerMetaDataBaseInterface *_t = static_cast<QDesignerMetaDataBaseInterface *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QDesignerMetaDataBaseInterface::staticMetaObjectExtraData = {
...
const QMetaObject QDesignerMetaDataBaseInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDesignerMetaDataBaseInterface,
      qt_meta_data_QDesignerMetaDataBaseInterface, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QDesignerMetaDataBaseInterface::getStaticMetaObject() { return staticMetaObject; }
