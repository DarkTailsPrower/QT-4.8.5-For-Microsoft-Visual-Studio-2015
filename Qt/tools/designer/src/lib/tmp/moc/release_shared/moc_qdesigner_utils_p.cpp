...
void qdesigner_internal::DesignerPixmapCache::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        DesignerPixmapCache *_t = static_cast<DesignerPixmapCache *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData qdesigner_internal::DesignerPixmapCache::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::DesignerPixmapCache::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qdesigner_internal__DesignerPixmapCache,
      qt_meta_data_qdesigner_internal__DesignerPixmapCache, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::DesignerPixmapCache::getStaticMetaObject() { return staticMetaObject; }
...
void qdesigner_internal::DesignerIconCache::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        DesignerIconCache *_t = static_cast<DesignerIconCache *>(_o);
        switch (_id) {
        case 0: _t->reloaded(); break;
        default: ;
        }
...
const QMetaObjectExtraData qdesigner_internal::DesignerIconCache::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};
...
const QMetaObject qdesigner_internal::DesignerIconCache::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qdesigner_internal__DesignerIconCache,
      qt_meta_data_qdesigner_internal__DesignerIconCache, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::DesignerIconCache::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
