...
void QAbstractFormBuilderGadget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
static const QMetaObjectAccessor qt_meta_extradata_QAbstractFormBuilderGadget[] = {
        QSizePolicy::getStaticMetaObject,
    QPalette::getStaticMetaObject,
    QFont::getStaticMetaObject,
    QGradient::getStaticMetaObject,
...
const QMetaObjectExtraData QAbstractFormBuilderGadget::staticMetaObjectExtraData = {
    qt_meta_extradata_QAbstractFormBuilderGadget,  qt_static_metacall 
};
...
const QMetaObject QAbstractFormBuilderGadget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QAbstractFormBuilderGadget,
      qt_meta_data_QAbstractFormBuilderGadget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QAbstractFormBuilderGadget::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
