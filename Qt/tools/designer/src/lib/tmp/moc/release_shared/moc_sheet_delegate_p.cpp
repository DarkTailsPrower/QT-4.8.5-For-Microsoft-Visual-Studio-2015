...
void qdesigner_internal::SheetDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::SheetDelegate::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::SheetDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_qdesigner_internal__SheetDelegate,
      qt_meta_data_qdesigner_internal__SheetDelegate, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::SheetDelegate::getStaticMetaObject() { return staticMetaObject; }
