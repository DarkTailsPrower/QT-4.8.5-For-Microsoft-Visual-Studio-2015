...
void QDesignerActionEditorInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QDesignerActionEditorInterface *_t = static_cast<QDesignerActionEditorInterface *>(_o);
        switch (_id) {
        case 0: _t->setFormWindow((*reinterpret_cast< QDesignerFormWindowInterface*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData QDesignerActionEditorInterface::staticMetaObjectExtraData = {
...
const QMetaObject QDesignerActionEditorInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QDesignerActionEditorInterface,
      qt_meta_data_QDesignerActionEditorInterface, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QDesignerActionEditorInterface::getStaticMetaObject() { return staticMetaObject; }
