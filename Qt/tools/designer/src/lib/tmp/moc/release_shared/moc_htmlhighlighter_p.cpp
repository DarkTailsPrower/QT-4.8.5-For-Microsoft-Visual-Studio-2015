...
void qdesigner_internal::HtmlHighlighter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData qdesigner_internal::HtmlHighlighter::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::HtmlHighlighter::staticMetaObject = {
    { &QSyntaxHighlighter::staticMetaObject, qt_meta_stringdata_qdesigner_internal__HtmlHighlighter,
      qt_meta_data_qdesigner_internal__HtmlHighlighter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::HtmlHighlighter::getStaticMetaObject() { return staticMetaObject; }
