...
void qdesigner_internal::ScriptDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        ScriptDialog *_t = static_cast<ScriptDialog *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData qdesigner_internal::ScriptDialog::staticMetaObjectExtraData = {
...
const QMetaObject qdesigner_internal::ScriptDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_qdesigner_internal__ScriptDialog,
      qt_meta_data_qdesigner_internal__ScriptDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qdesigner_internal::ScriptDialog::getStaticMetaObject() { return staticMetaObject; }
