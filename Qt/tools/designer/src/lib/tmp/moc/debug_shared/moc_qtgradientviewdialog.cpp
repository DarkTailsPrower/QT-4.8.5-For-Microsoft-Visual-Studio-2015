...
void QtGradientViewDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QtGradientViewDialog *_t = static_cast<QtGradientViewDialog *>(_o);
        switch (_id) {
        case 0: _t->slotGradientSelected((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->slotGradientActivated((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData QtGradientViewDialog::staticMetaObjectExtraData = {
...
const QMetaObject QtGradientViewDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QtGradientViewDialog,
      qt_meta_data_QtGradientViewDialog, &staticMetaObjectExtraData }
};
