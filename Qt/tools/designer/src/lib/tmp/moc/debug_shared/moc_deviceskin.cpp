...
const QMetaObjectExtraData DeviceSkin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DeviceSkin::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DeviceSkin,
      qt_meta_data_DeviceSkin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DeviceSkin::getStaticMetaObject() { return staticMetaObject; }
