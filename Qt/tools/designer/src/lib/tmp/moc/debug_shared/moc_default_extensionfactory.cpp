...
void QExtensionFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QExtensionFactory *_t = static_cast<QExtensionFactory *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QExtensionFactory::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QExtensionFactory::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QExtensionFactory,
      qt_meta_data_QExtensionFactory, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QExtensionFactory::getStaticMetaObject() { return staticMetaObject; }
