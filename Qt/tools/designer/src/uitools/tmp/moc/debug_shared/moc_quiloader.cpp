...
void QUiLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QUiLoader::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QUiLoader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QUiLoader,
      qt_meta_data_QUiLoader, &staticMetaObjectExtraData }
};
