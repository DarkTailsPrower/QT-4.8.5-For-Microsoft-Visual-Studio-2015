...
void QDesignerToolWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QDesignerToolWindow *_t = static_cast<QDesignerToolWindow *>(_o);
        switch (_id) {
        case 0: _t->showMe((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData QDesignerToolWindow::staticMetaObjectExtraData = {
...
const QMetaObject QDesignerToolWindow::staticMetaObject = {
    { &MainWindowBase::staticMetaObject, qt_meta_stringdata_QDesignerToolWindow,
      qt_meta_data_QDesignerToolWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QDesignerToolWindow::getStaticMetaObject() { return staticMetaObject; }
