...
static const char qt_meta_stringdata_OpenPagesSwitcher[] = {
    "OpenPagesSwitcher\0\0index\0"
...
const QMetaObjectExtraData OpenPagesSwitcher::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject OpenPagesSwitcher::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_OpenPagesSwitcher,
      qt_meta_data_OpenPagesSwitcher, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &OpenPagesSwitcher::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OpenPagesSwitcher))
        return static_cast<void*>(const_cast< OpenPagesSwitcher*>(this));
