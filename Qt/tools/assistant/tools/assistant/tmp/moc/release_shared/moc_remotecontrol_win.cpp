...
static const char qt_meta_stringdata_StdInListenerWin[] = {
    "StdInListenerWin\0\0cmd\0receivedCommand(QString)\0"
};
...
const QMetaObjectExtraData StdInListenerWin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StdInListenerWin::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_StdInListenerWin,
      qt_meta_data_StdInListenerWin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StdInListenerWin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StdInListenerWin))
