...
void TopicChooser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData TopicChooser::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TopicChooser::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_TopicChooser,
      qt_meta_data_TopicChooser, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TopicChooser::getStaticMetaObject() { return staticMetaObject; }
