...
static const char qt_meta_stringdata_HelpEngineWrapper[] = {
    "HelpEngineWrapper\0\0namespaceName\0"
    "documentationRemoved(QString)\0"
    "documentationUpdated(QString)\0"
    "currentFilter\0currentFilterChanged(QString)\0"
    "setupFinished()\0filter\0"
    "handleCurrentFilterChanged(QString)\0"
};
...
const QMetaObjectExtraData HelpEngineWrapper::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject HelpEngineWrapper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HelpEngineWrapper,
      qt_meta_data_HelpEngineWrapper, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &HelpEngineWrapper::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HelpEngineWrapper))
        return static_cast<void*>(const_cast< HelpEngineWrapper*>(this));
