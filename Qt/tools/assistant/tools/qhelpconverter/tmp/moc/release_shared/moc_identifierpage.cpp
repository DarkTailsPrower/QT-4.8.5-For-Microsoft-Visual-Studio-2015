...
const QMetaObjectExtraData IdentifierPage::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject IdentifierPage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_IdentifierPage,
      qt_meta_data_IdentifierPage, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &IdentifierPage::getStaticMetaObject() { return staticMetaObject; }
