...
void ConversionWizard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        ConversionWizard *_t = static_cast<ConversionWizard *>(_o);
        switch (_id) {
        case 0: _t->pageChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->showHelp((*reinterpret_cast< bool(*)>(_a[1]))); break;
...
const QMetaObjectExtraData ConversionWizard::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ConversionWizard::staticMetaObject = {
    { &QWizard::staticMetaObject, qt_meta_stringdata_ConversionWizard,
      qt_meta_data_ConversionWizard, &staticMetaObjectExtraData }
};
