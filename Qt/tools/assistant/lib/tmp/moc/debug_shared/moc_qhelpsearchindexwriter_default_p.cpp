...
static const char qt_meta_stringdata_fulltextsearch__std__QHelpSearchIndexWriter[] = {
...
const QMetaObjectExtraData fulltextsearch::std::QHelpSearchIndexWriter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject fulltextsearch::std::QHelpSearchIndexWriter::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_fulltextsearch__std__QHelpSearchIndexWriter,
      qt_meta_data_fulltextsearch__std__QHelpSearchIndexWriter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &fulltextsearch::std::QHelpSearchIndexWriter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_fulltextsearch__std__QHelpSearchIndexWriter))
