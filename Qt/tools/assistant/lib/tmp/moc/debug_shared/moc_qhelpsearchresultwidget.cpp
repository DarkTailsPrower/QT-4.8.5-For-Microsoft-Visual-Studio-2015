...
void QHelpSearchResultWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QHelpSearchResultWidget *_t = static_cast<QHelpSearchResultWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QHelpSearchResultWidget::staticMetaObjectExtraData = {
...
const QMetaObject QHelpSearchResultWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QHelpSearchResultWidget,
      qt_meta_data_QHelpSearchResultWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QHelpSearchResultWidget::getStaticMetaObject() { return staticMetaObject; }
