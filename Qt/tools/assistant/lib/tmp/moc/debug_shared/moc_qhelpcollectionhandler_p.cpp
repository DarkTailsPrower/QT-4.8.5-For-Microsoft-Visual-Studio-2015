...
void QHelpCollectionHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QHelpCollectionHandler *_t = static_cast<QHelpCollectionHandler *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QHelpCollectionHandler::staticMetaObjectExtraData = {
...
const QMetaObject QHelpCollectionHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QHelpCollectionHandler,
      qt_meta_data_QHelpCollectionHandler, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QHelpCollectionHandler::getStaticMetaObject() { return staticMetaObject; }
