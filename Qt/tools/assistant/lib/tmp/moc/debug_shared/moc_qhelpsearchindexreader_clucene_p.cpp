...
void fulltextsearch::clucene::QHelpSearchIndexReaderClucene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData fulltextsearch::clucene::QHelpSearchIndexReaderClucene::staticMetaObjectExtraData = {
...
const QMetaObject fulltextsearch::clucene::QHelpSearchIndexReaderClucene::staticMetaObject = {
    { &QHelpSearchIndexReader::staticMetaObject, qt_meta_stringdata_fulltextsearch__clucene__QHelpSearchIndexReaderClucene,
      qt_meta_data_fulltextsearch__clucene__QHelpSearchIndexReaderClucene, &staticMetaObjectExtraData }
};
