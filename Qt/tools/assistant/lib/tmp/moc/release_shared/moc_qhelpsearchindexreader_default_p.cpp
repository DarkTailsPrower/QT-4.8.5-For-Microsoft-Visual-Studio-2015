...
static const char qt_meta_stringdata_fulltextsearch__std__QHelpSearchIndexReaderDefault[] = {
    "fulltextsearch::std::QHelpSearchIndexReaderDefault\0"
};
...
const QMetaObjectExtraData fulltextsearch::std::QHelpSearchIndexReaderDefault::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject fulltextsearch::std::QHelpSearchIndexReaderDefault::staticMetaObject = {
    { &QHelpSearchIndexReader::staticMetaObject, qt_meta_stringdata_fulltextsearch__std__QHelpSearchIndexReaderDefault,
      qt_meta_data_fulltextsearch__std__QHelpSearchIndexReaderDefault, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &fulltextsearch::std::QHelpSearchIndexReaderDefault::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_fulltextsearch__std__QHelpSearchIndexReaderDefault))
