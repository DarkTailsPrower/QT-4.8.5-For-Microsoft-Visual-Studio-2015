...
template<typename _kt, typename _vt, 
	...
	typename _KeyDeletor=CL_NS(util)::Deletor::Dummy,
	typename _ValueDeletor=CL_NS(util)::Deletor::Dummy>
class CLSet: public __CLMap<_kt, _vt, std::map<_kt, _vt, _Compare>, _KeyDeletor, _ValueDeletor>
{
public:
	CLSet ( const bool deleteKey=false, const bool deleteValue=false )
	{
		this->setDeleteKey(deleteKey);
...
template<typename _kt, typename _vt,
	...
	typename _KeyDeletor=CL_NS(util)::Deletor::Dummy,
	typename _ValueDeletor=CL_NS(util)::Deletor::Dummy>
class CLMultiMap: public __CLMap<_kt, _vt, std::multimap<_kt, _vt, _Compare>, _KeyDeletor, _ValueDeletor>
{
public:
