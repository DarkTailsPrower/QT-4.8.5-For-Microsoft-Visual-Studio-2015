...
namespace WTF {
    ...
    template<typename T> struct HasTrivialConstructor { static const bool value = __has_trivial_constructor(T); };
    template<typename T> struct HasTrivialDestructor { static const bool value = __has_trivial_destructor(T); };
#else
