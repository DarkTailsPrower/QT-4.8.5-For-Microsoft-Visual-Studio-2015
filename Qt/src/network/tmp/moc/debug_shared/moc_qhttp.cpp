...
void QHttp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 11: _t->d_func()->_q_startNextRequest(); break;
        case 12: _t->d_func()->_q_slotReadyRead(); break;
        case 13: _t->d_func()->_q_slotConnected(); break;
        case 14: _t->d_func()->_q_slotError((*reinterpret_cast< QAbstractSocket::SocketError(*)>(_a[1]))); break;
        case 15: _t->d_func()->_q_slotClosed(); break;
        case 16: _t->d_func()->_q_slotBytesWritten((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 17: _t->d_func()->_q_slotDoFinished(); break;
        case 18: _t->d_func()->_q_slotSendRequest(); break;
        case 19: _t->d_func()->_q_continuePost(); break;
        default: ;
        }
    }
}
