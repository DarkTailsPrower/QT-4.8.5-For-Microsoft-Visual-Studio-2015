...
void ChaseWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData ChaseWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ChaseWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ChaseWidget,
      qt_meta_data_ChaseWidget, &staticMetaObjectExtraData }
};
